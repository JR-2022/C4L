...
•	Confidential Client: Für serverseitige Anwendungen, die ein Client-Secret sicher speichern und sich damit beim Authorization Server authentifizieren (Flow: Authorization Code mit Client-Authentifizierung)
•	M2M Client: Für Maschinen-zu-Maschinen-Kommunikation ohne Benutzerkontext. (Flow: Client Credentials)
